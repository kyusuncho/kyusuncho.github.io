...
See [the Code documentation]({% link ui-components/code/index.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({% link navigation/main/external.md %}) for more details.
...
See [Customization]({% link customization.md %}) for more information.
...
See [Callouts]({% link ui-components/callouts.md %}) for more information. The colors used in the theme are further described in [Color Utilities]({% link utilities/color.md %}).
